if __name__ == '__main__':
    ...
    output = [idx for idx, val in enumerate(v) if val == n]  # Put your line here (my solution: 37 chars)
    print(output)
    ...
    """
    v, n = [f(x) for f, x in zip((eval, int), input().split())]
    output = ''.join('=' if val == n else '!' for idx, val in enumerate(v))  # Put your line here
    print(output)
    ...
    """
    v = eval(input())
    output = sorted(list(set(v)))  # Put your line here (my solution: 14 chars. Hint: choose the right datatype)
    print(output)
    ...
    output = int(sqrt(sum((i - j) ** 2 for i, j in zip(u, v))))  # Put your line here (my solution: 40 chars)
    print(output)
    ...
    """
    m = eval(input())
    output = [idx for cel in m for idx in cel]  # Put your line here (my solution: 9 chars)
    print(output)
    ...
    """
    m = eval(input())
    output = [list(row) for row in zip(*m)]  # Put your line here (my solution: 24 chars. Hint: *m)
    print(output)
